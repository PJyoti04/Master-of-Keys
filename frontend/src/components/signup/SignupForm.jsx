...
const SignupForm = () => {
  ...
  return (
    <div className="md:w-[650px] h-[75vh] rounded-2xl flex bg-[linear-gradient(to_right,#FAEBCE_0%,#FAEBCE_20%,#ff9100_70%,#ff9100_100%)]">
      <div className="w-full backdrop-blur-3xl bg-white/10 flex rounded-2xl">
        {/* Image Section */}
        <div className="hidden md:block p-8 bg-[url(/signup_image-bgremoved.png)] bg-[contain] bg-center bg-no-repeat -[#FAEBCE] w-[60%] rounded-s-2xl text-[orange] relative ">
        ...
        {/* Form Section */}
        <div className="-[#ff9100] md:rounded-e-2xl md:rounded-none rounded-2xl ">
          <h2 className="text-2xl text-[white] font-bold text-center underline underline-offset-4 pt-16 p-9">
            Sign Up
          </h2>
          <form
            onSubmit={handleSubmit}
            className="space-y-4 p-4 text-[orange] "
          >
            <input
              type="text"
              name="username"
